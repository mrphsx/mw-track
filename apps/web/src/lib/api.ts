...
// Реэкспорт для существующих потребителей (напр. landing-content-card.tsx) — само значение
// теперь в отдельном файле без импортов, см. его комментарий (циклический импорт с auth.store.ts).
export { API_BASE_URL };
