...
// Извлечено из .../projects/[id]/personal-broadcasts/new/page.tsx (запрос пользователя
// 2026-08-14: та же форма нужна и Operator-у на /my-personal-broadcasts/new) — projectId и
// onCreated параметризованы вместо useParams+router.push("/projects/:id/...") напрямую, тот же
// приём, что уже применён к списку выше (broadcast-list.tsx) и раньше к PushComposer.
