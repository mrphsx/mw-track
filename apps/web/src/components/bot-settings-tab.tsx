...
// команда вручную фиксирует диалоги и покупки (с 2026-09-17), присылая боту клиента, вместо
// того чтобы заводить MTProto-сессию. Менеджеры никогда не становятся Client — бот перехватывает их
