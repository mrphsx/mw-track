...
// Извлечено из .../studio/projects/[id]/personal-broadcasts/new/page.tsx (запрос пользователя
// 2026-08-14: та же форма нужна и Operator-у на /dashboard/studio/my-personal-broadcasts/new) —
// projectId/onCreated параметризованы вместо useParams+router.push напрямую, тот же приём, что
// и в классическом дереве (components/personal-broadcasts/broadcast-composer.tsx).
export function PersonalBroadcastComposer({ projectId, onCreated }: { projectId: string; onCreated: () => void }) {
