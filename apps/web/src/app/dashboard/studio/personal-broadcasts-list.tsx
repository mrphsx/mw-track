...
// Извлечено из .../studio/projects/[id]/personal-broadcasts/page.tsx (запрос пользователя
// 2026-08-14: та же страница нужна и Operator-у на /dashboard/studio/my-personal-broadcasts) —
// projectId/newHref параметризованы вместо useParams, тот же приём, что и в классическом дереве
// (components/personal-broadcasts/broadcast-list.tsx).
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        {project?.channel?.tgPersonalConnected && hasPermission(user, projectId, 'PERSONAL_BROADCASTS_CREATE') && (
          <StudioLinkButton variant="primary" icon={Plus} href={newHref}>
            Новая рассылка
          </StudioLinkButton>
        )}
      </div>
