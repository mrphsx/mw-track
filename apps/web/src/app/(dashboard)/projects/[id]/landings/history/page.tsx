  ...
  return (
    <div className="space-y-6">
      ...
      {!isLoading && endedGroups.length === 0 && (
        <Card>
          <CardContent className="p-8 text-center text-gray-500">Завершённых тестов пока нет.</CardContent>
        </Card>
      )}
          ...
          <Card key={g.id}>
            <CardContent className="p-4 space-y-2">
              <div className="flex items-start justify-between gap-4">
                ...
                <Button size="sm" variant="ghost" onClick={() => deleteHistory.mutate(g.id)} disabled={deleteHistory.isPending}>
